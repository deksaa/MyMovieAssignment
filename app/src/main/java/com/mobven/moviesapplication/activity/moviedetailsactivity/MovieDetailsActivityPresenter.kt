...
//@Inject constructor() : MovieDetailsActivityContract.Presenter
{
...
//            if (response.success!!)
//            {
//                Log.d(this@MovieDetailsActivityPresenter.javaClass.simpleName, String.format("Request_Token ->>> %s", response.requestToken))
...
//            Log.e(this@MovieDetailsActivityPresenter.javaClass.simpleName, t.localizedMessage!!)
//            mView.showToastMessage(ErrorMessages.GENERAL_ERROR, Toast.LENGTH_LONG)
//            mView.finishActivity()
//        }
//    }
...
//            if (response.success!!)
//            {
//                Log.d(this@MovieDetailsActivityPresenter.javaClass.simpleName, String.format("Session_ID ->>> %s", response.sessionId))
